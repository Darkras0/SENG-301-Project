var search = require('./searchParser.js');
var genre = require('./genreParser.js');
var $ = require('jquery');

exports.recommendAnimeOnce = function recommendAnimeOnce(toSearch, callback) {
var complete = [];
var f = "";

	search.searchResults(toSearch, f, function(call1) {
		...
		var e;
		genre.genreResults(d, function(call2) {
			e = call2;
			var m;
			...
			var h;
			var p;
			search.searchResults(g, f, function(call4) {
				h = call4;
				//alert(h[1]);
				//alert(a[0]);
